...
import { EntityManager, FindCondition, In } from "typeorm";
import { DeepPartial } from "ts-essentials";
import { UserRole, UserState, UserEntity } from "@app/entity";
 ...
 */
@Injectable()
export class BaseUserService extends CRUDService<UserEntity>  {
